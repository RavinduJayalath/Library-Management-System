...
namespace Library
{
    public partial class FOT : Form
    {
        ...
        public FOT(string name)
        {
            InitializeComponent();
            this.username = name;
        }

        private void FOT_Load(object sender, EventArgs e)
        {
            loadcontent();
        }
        ...
        private void loadcontent()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select title from book where faculty='Faculty Of Technology'", con);
            con.Open();
