...
namespace Library
{
    public partial class FOA : Form
    {
        ...
        public FOA(string name)
        {
            InitializeComponent();
            this.username = name;
        }

        private void FOA_Load(object sender, EventArgs e)
        {
            loadcontent();
        }
        private void loadcontent()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select title from book where faculty='Faculty Of Applied Science'", con);
            con.Open();
